   ...
   /* private void showSampleLogs() {
    ...
    private void initializeEngine() {
        try {
            ...
            Log.e("aaaaaa initializeEngine", Log.getStackTraceString(e));
...
//        int res = mMuted ? R.drawable.ic_launcher_background : R.drawable.ic_launcher_foreground;
...
//    }
    ...
    public void onCallClicked(View view) {
        if (mCallEnd) {
            startCall();
            mCallEnd = false;
           // mCallBtn.setImageResource(R.drawable.ic_launcher_background);
        } else {
            endCall();
            mCallEnd = true;
           // mCallBtn.setImageResource(R.drawable.ic_launcher_foreground);
        }
